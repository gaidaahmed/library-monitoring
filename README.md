...
|-------------------------|----------------------------------------------|
| `library/`              | Root folder                                   |
| `library/api/`          | gRPC generated protobuf files                 |
| `library/client/`       | Demo gRPC client                              |
| `library/server/`       | Prometheus-instrumented gRPC server           |
| `library/Dockerfile`    | Multi-stage Docker build                      |
| `library/library-server-chart/` | Helm chart for Kubernetes deployment |
